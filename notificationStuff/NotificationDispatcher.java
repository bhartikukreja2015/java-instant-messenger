...
public class NotificationDispatcher {
	...
	public void dispatchNotification(Notification theNot) {
		...
		if (pp.getNotificationType().equals(PreferencePoint.notifysendNotification)) {
			...
			// we don't need to read theWindow... the constructor of theWindow does all the work for us.
			NotificationWindow theWindow = new NotificationWindow(theFetch.loadImage(theNot.getIconHint()), theNot.getSubject(), theNot.getMessage(), 10000);
		}
	}
