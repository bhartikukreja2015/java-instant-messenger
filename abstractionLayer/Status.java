...
public class Status {
	...
	public void setStatus(String status) { statusType = status; }
	public void setStatusMessage(String message) { statusMessage = message; }
	
	public String getStatus() { return statusType; }
	public String getStatusMessage() { return statusMessage; }
	
	public boolean isOnline() { return !(statusType.equals(Status.offline)); }
}
